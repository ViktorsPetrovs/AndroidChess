...
public class Initialization {
	...
	public  void startingPositions(){
		...
		board.setCoordinates(0, 0, new Rooks(0,0,false));
		board.setCoordinates(0, 1, new Knight(0,1,false));
		board.setCoordinates(0, 2, new Bishop(0,2,false));
		board.setCoordinates(0, 3, new Queen(0,3,false));
		board.setCoordinates(0, 4, new King(0,4,false));
		board.setCoordinates(0, 5, new Bishop(0,5,false));
		board.setCoordinates(0, 6, new Knight(0,6,false));
		board.setCoordinates(0, 7, new Rooks(0,7,false));
